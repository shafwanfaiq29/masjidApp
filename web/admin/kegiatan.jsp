    ...
    <%@page import="com.masjid.config.Koneksi" %>
        <%@page contentType="text/html" pageEncoding="UTF-8" %>
            <% if(session.getAttribute("adminId")==null){ response.sendRedirect("../login.jsp"); return; } String
                ...
                if(!canAccessKegiatan){ response.sendRedirect("dashboard.jsp?error=access"); return; } %>
                <!DOCTYPE html>
                <html>
                    ...
                    <div class="sidebar">
                        ...
                        <ul class="nav-menu">
                            ...
                            <% if(canAccessKegiatan) { %>
                                <li><a href="kegiatan.jsp" class="active"><i
                                            class="fas fa-calendar-days"></i><span>Kelola Kegiatan</span></a></li>
                                <% } %>
                            ...
                            <div class="table-wrapper">
                                <table>
                                    ...
                                    <tbody id="kegiatanBody">
                                        <tr>
                                            <td colspan="7" class="loading"><i class="fas fa-spinner"></i> Memuat
                                                data...</td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <div class="modal-content">
                            ...
                            <form id="editForm">
                                ...
                                <div class="form-actions">
                                    <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i>
                                        Simpan</button>
                                    <button type="button" class="btn btn-secondary" onclick="closeEdit()"><i
                                            class="fas fa-times"></i>
                                        Batal</button>
                                </div>
                            </form>
