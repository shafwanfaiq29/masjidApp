    ...
    <div class="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li id="menuKeuangan"><a href="keuangan.jsp"><i class="fas fa-money-bill-wave"></i><span>Kelola
                        Keuangan</span></a></li>
            <li id="menuArsip"><a href="arsip.jsp" class="active"><i class="fas fa-folder-open"></i><span>Kelola
                        Arsip</span></a></li>
            ...
            <form action="../ArsipServlet" method="post" enctype="multipart/form-data" id="uploadForm">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_dokumen" required placeholder="Masukkan nama dokumen">
                    </div>
                    <div class="form-group">
        ...
        <div class="card">
            ...
            <div class="filter-section">
                <div class="search-box form-group">
                    ...
                    <input type="text" id="searchInput" placeholder="Cari nama dokumen atau deskripsi...">
                </div>
                <div class="form-group">
                    <label><i class="fas fa-tag"></i> Kategori</label>
            ...
            <div class="table-wrapper">
                <table>
                    ...
                    <tbody id="arsipBody">
                        <tr>
                            <td colspan="6" class="loading"><i class="fas fa-spinner"></i> Memuat data...</td>
                        </tr>
                    </tbody>
                </table>
            </div>
