                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select name="role" required>
                            ...
                            <option value="Idarah">Idarah (Arsip)</option>
                            <option value="Imarah">Imarah (Kegiatan)</option>
                            <option value="Riayah">Riayah (Keuangan)</option>
                        </select>
                    </div>
                </div>
...
%>
                        <tr>
                            ...
                            <td><%= username %></td>
                            <td><span class="badge <%= role.toLowerCase() %>"><i class="fas fa-user-tag"></i> <%= role %></span></td>
                            <td>
                                <button class="btn-edit" onclick="openEdit(<%= id %>, '<%= namaJs %>', '<%= username %>', '<%= role %>')"><i class="fas fa-pen-to-square"></i> Edit</button>
                                <form action="../UserServlet" method="post" style="display:inline;" onsubmit="return confirm('Yakin hapus user ini?')">
                                    <input type="hidden" name="action" value="delete">
                                    <input type="hidden" name="id" value="<%= id %>">
                                    <button type="submit" class="btn-delete" <%= isSelf ? "disabled title='Tidak dapat menghapus akun sendiri'" : "" %>><i class="fas fa-trash-can"></i> Hapus</button>
                                </form>
                            </td>
                        </tr>
<%
...
if (!hasData) {
%>
                        <tr><td colspan="5" class="no-data"><i class="fas fa-users"></i>Belum ada user</td></tr>
<%
}
%>
                    </tbody>
    ...
    <div class="modal" id="editModal">
        <div class="modal-content">
            <div class="modal-header">
                <h3><i class="fas fa-pen-to-square"></i> Edit User</h3>
