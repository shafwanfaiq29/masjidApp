...
<body>
    ...
    <div class="bg-decoration"></div>
    <div class="container">
        <div class="mosque-icon"><i class="fas fa-mosque"></i></div>
        ...
        <p class="welcome-text"><i class="fas fa-hand-point-right"></i>&nbsp; Silakan pilih cara Anda mengakses website
        </p>
        ...
        <p class="footer-text"><i class="fas fa-mosque"></i> Masjid Jabalussalam <i class="fas fa-heart"></i></p>
    </div>
</body>
